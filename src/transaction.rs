    ...
    T: serde::de::DeserializeOwned,
{
    ...
    let json_array = get_json_from_file("/Users/mac/Desktop/ecs189f/resdb_rust_sdk/json_data/transactions.json").await?;
    ...
    T: serde::de::DeserializeOwned + std::default::Default,
{
    ...
    let json_array = get_json_from_file("/Users/mac/Desktop/ecs189f/resdb_rust_sdk/json_data/transactions:id.json").await?;
